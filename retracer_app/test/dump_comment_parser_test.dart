...
[65da146f-95d9-465b-85d1-c74c07a479a3.zip](https://github.com/boyan01/mixin_crash_dump_retracer/files/9531653/65da146f-95d9-465b-85d1-c74c07a479a3.zip)

""";
    final result = parseDumpComment(content);
    expect(result, isNotNull);
    expect(result!.version, '0.37.1');
  });
}
